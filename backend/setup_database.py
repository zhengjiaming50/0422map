...
# 从环境变量获取数据库配置
db_url = os.environ.get('DATABASE_URL', 'postgresql://postgres:postgres@localhost:5432/wuhan_food_map')
test_db_url = os.environ.get('TEST_DATABASE_URL', 'postgresql://postgres:postgres@localhost:5432/wuhan_food_map_test')
