...
| error | ref | 错误信息 |
| markers | ref | 餐厅标记集合 |
| heatmapVisible | computed | 热力图显示状态 |
...
| toggleHeatmap() | Function | 切换热力图显示状态 |
| initHeatmapLayer() | Function | 初始化热力图图层 |
| updateHeatmapData() | Function | 更新热力图数据 |
...
| getRestaurantsDensity | filters: Object | Promise<Array> | 获取餐厅密度数据，用于热力图显示 |
...
| heatmap | Object | 热力图状态 (visible: Boolean, data: Array, lastUpdated: Date) |
...
| fetchRestaurantsInBox | bounds: Object | 获取地图可视区域内的餐厅 |
| fetchHeatmapData | - | 获取热力图数据 |
| toggleHeatmap | - | 切换热力图显示状态 |
