  ...
  <div class="restaurant-info">
    ...
    <div class="add-review-section">
      ...
      <div class="form-group">
        <input v-model="newReview.user_name" placeholder="用户名">
      </div>
      <div class="form-group">
        <textarea v-model="newReview.comment" placeholder="评论"></textarea>
      </div>
...
| reviews | ref | 当前餐厅的评价列表 |
| loading | ref | 评价数据加载状态 |
| error | ref | 评价加载错误信息 |
| newReview | ref | 新评价表单数据对象 |
| submitReview | Function | 提交新评价的方法 |
| fetchReviews | Function | 获取餐厅评价的方法 |
| formatDate | Function | 格式化日期的辅助方法 |

**样式说明**
| 类名 | 描述 |
|------|------|
| .reviews-section | 评价展示区域，顶部有分隔线 |
| .review-item | 单条评价的容器，包含用户名、评分、日期和内容 |
| .review-rating | 评分显示区域，使用星星图标表示 |
| .add-review-section | 添加评价表单区域，顶部有分隔线 |
| .star-rating | 评分选择控件，可交互的星星图标 |
| .form-input, .form-textarea | 表单输入控件样式 |
| .submit-review-btn | 提交评价按钮，红色背景白色文字 |
...
| getRestaurantReviews | restaurantId: Number | Promise<Array> | 获取指定餐厅的评价列表 |
| addRestaurantReview | restaurantId: Number, reviewData: Object | Promise<Object> | 为指定餐厅添加新评价 |
...
| fetchRestaurantReviews | restaurantId: Number | 获取指定餐厅的评价列表 |
| addReview | restaurantId: Number, reviewData: Object | 为指定餐厅添加新评价 |
