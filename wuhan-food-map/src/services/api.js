...
export const foodCultureApi = {
  ...
  async getFoodCultures(filters = {}) {
    try {
      ...
      const url = `${API_BASE_URL}/food-culture/?${queryParams.toString()}`
      const response = await fetch(url)
  ...
  // 获取指定ID的美食文化详情
  async getFoodCultureById(id) {
    try {
      const response = await fetch(`${API_BASE_URL}/food-culture/${id}`)
  ...
  async getFoodTypes() {
    try {
      const response = await fetch(`${API_BASE_URL}/food-culture/food-types`)
  ...
  // 获取发源地区列表
  async getOriginDistricts() {
    try {
      const response = await fetch(`${API_BASE_URL}/food-culture/districts`)
  ...
  // 获取美食路线列表
  async getFoodRoutes(district = '') {
    try {
      const queryParams = new URLSearchParams()
      if (district) queryParams.append('district', district)
      
      const url = `${API_BASE_URL}/food-culture/routes?${queryParams.toString()}`
      const response = await fetch(url)
  ...
  // 获取指定ID的美食路线详情
  async getFoodRouteById(id) {
    try {
      const response = await fetch(`${API_BASE_URL}/food-culture/routes/${id}`)
